...
try:
    from .core.segmentation import SparseSegmentMasker
...
class ConceptGraphData:
    ...
    _segment_masker: ClassVar[SparseSegmentMasker] = SparseSegmentMasker()
    ...
    def load(cls, map_path: str | Path, *, arcs_enabled: bool = True) -> "ConceptGraphData":
        ...
        pcd_o3d = cls._segment_masker.split_objects(pcd, segments_anno)
